...
{
    cout<<"Nhap Gio Bat Dau:";getline(input,a.time_start);
    cout<<"Nhap Ten Cong Viec:";getline(input,a.ten_cong_viec);
    cout<<"Nhap Noi Dung:";getline(input,a.noi_dung);
    cout<<"Nhap Tinh Chat Cong Viec:";getline(input,a.tinh_chat_cong_viec);
    return input;
}
